 ...
 */
public class FragmentFingerprint
    extends Fragment
    ...
    public View onCreateView(
        ...
        View authModalView = inflater.inflate(
            R.layout.fingerprint_dialog_container,
            container,
            false
        );
        message = (TextView) authModalView.findViewById(
            R.id.fingerprint_description
        );
        title = (TextView) authModalView.findViewById(R.id.fingerprint_title);
        fingerPrintLayout = (LinearLayout) authModalView.findViewById(
            R.id.fingerprint_layout
        );
        fingerprintBackground = (RelativeLayout) authModalView.findViewById(
        ...
        FingerprintManager mFingerprintManager =
            (FingerprintManager) getActivity()
        ...
        mFingerprintUiHelper = mFingerprintUiHelperBuilder.build(
            (ImageView) authModalView.findViewById(R.id.fingerprint_icon),
            (TextView) authModalView.findViewById(R.id.fingerprint_status),
            this,
            getContext()
        );
        View mFingerprintContent = authModalView.findViewById(
            R.id.fingerprint_container
        );

        Button mCancelButton = (Button) authModalView.findViewById(
            R.id.cancel_button
        );
        Button mSecondDialogButton = (Button) authModalView.findViewById(
            R.id.second_dialog_button
        );
        ...
        mSecondDialogButton.setText(
            getString(R.string.Prompts_TouchId_usePin_android)
        );
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        final ViewTreeObserver observer =
            fingerPrintLayout.getViewTreeObserver();
    ...
    public void onStop() {
        super.onStop();
        if (!authSucceeded) completion.onCancel();
    }
    ...
    private void animateBackgroundDim(boolean reverse) {
        int transColor = reverse
            ? R.color.black_trans
            : android.R.color.transparent;
        int blackTransColor = reverse
            ? android.R.color.transparent
            : R.color.black_trans;
    ...
    private void animateSignalSlide(final boolean reverse) {
        ...
        if (!reverse) {
            fingerPrintLayout.setTranslationY(
                layoutTY + BreadActivity.screenParametersPoint.y
            );
            fingerPrintLayout
                .animate()
