...
public class FragmentMenu extends Fragment {
    ...
    public View onCreateView(
        ...
        itemList.add(
            new BRMenuItem(
                getString(R.string.MenuButton_security),
        ...
        itemList.add(
            new BRMenuItem(
                getString(R.string.MenuButton_support),
                ...
                v -> {
                    ...
                    customTabsIntent.launchUrl(
                        getContext(),
                        Uri.parse(BRConstants.CUSTOMER_SUPPORT_LINK)
                    );
                }
            )
        );
        ...
        itemList.add(
            new BRMenuItem(
                getString(R.string.MenuButton_settings),
        ...
        itemList.add(
            new BRMenuItem(
                getString(R.string.MenuButton_lock),
                R.drawable.ic_lock,
                v -> {
                    closeMenu();
        ...
        mListView.setAdapter(
            new MenuListAdapter(getContext(), R.layout.menu_list_item, itemList)
        );
        signalLayout.setOnTouchListener(
            new SlideDetector(signalLayout, this::closeMenu)
        );
