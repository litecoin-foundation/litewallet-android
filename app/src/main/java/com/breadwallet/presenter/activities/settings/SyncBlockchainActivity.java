...
public class SyncBlockchainActivity extends BRActivity {
    ...
    private void updateSyncPreference() {
        float fprate = BRSharedPrefs.getFalsePositivesRate(
            SyncBlockchainActivity.this
        );
        String rateAsString = String.format("%1.5f", fprate);
        syncPreferenceTextView.setText(
            getString(R.string.sync_preferences, rateAsString)
        );
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lowPrivacyButton.setOnClickListener(
            new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    BRSharedPrefs.putFalsePositivesRate(
                        SyncBlockchainActivity.this,
                        BRConstants.FALSE_POS_RATE_LOW_PRIVACY
                    );
                    updateSyncPreference();
                }
            }
        ...
        semiPrivateButton.setOnClickListener(
            new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    BRSharedPrefs.putFalsePositivesRate(
                        SyncBlockchainActivity.this,
                        BRConstants.FALSE_POS_RATE_SEMI_PRIVACY
                    );
                    updateSyncPreference();
                }
            }
        ...
        anonymousButton.setOnClickListener(
            new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    BRSharedPrefs.putFalsePositivesRate(
                        SyncBlockchainActivity.this,
                        BRConstants.FALSE_POS_RATE_ANONYMOUS
                    );
                    updateSyncPreference();
                }
            }
            ...
            new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    BRDialog.showCustomDialog(
                        ...
                        getString(R.string.ReScan_footer),
                        getString(R.string.ReScan_alertAction),
